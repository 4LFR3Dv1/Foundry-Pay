...
| FP-PROTO-007 | active | FP-PROTO-003, SA-GW-002 | bind `obligation_id` in the draft v1 commitment |
...
| FP-AUTH-001 | blocked | FP-PROTO-007, SA-GW-002 | short-lived exact-message execution authorization |
