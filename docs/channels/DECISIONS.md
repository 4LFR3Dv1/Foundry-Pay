...
| FC-D-009 | accepted | closure freezes the latest activated right and preserves it through a claim window | only unallocated value is immediately refundable | [CHANNEL_PROTOCOL](CHANNEL_PROTOCOL.md) |
