...
| FC-T21 | Sender revokes activated value | recipient right | close/refund | no voucher decrease, no Cloud revocation authority, close reserves outstanding until expiry | attempted invalid transition | reject; recipient settles during grace | activated voucher/Channel/close state | Low by design; expiry policy remains product risk |
